...
export const catalogs = [
  ...
  },
  {
    ...
    categories: [
      { name: "White Sugar", description: "Refined and granulated for everyday cooking.", image: "/white sugar.jpeg", subItems: [{ name: "White Sugar", description: "Refined granulated sugar. Price: Not specified", priceRange: "Sumit Inquiry For Rates" }] },
      { name: "Brown Sugar", description: "Contains molasses, adds caramel flavor.", image: "/brownsugar eatable.jpeg", subItems: [{ name: "Brown Sugar", description: "With molasses. Price: Not specified", priceRange: "Sumit Inquiry For Rates" }] },
      { name: "Jaggery", description: "Unrefined sugar made from cane, traditional sweetener.", image: "/jaggry.jpeg", subItems: [{ name: "Jaggery", description: "Traditional cane sugar. Price: Not specified", priceRange: "Sumit Inquiry For Rates" }] },
    ]
  },
  {
    name: "Spices",
    ...
    categories: [
      {
        ...
        subItems: [
          { name: "Vegetable Oil", description: "Soybean or sunflower. Price: Not specified", priceRange: "Submit Request For Rates" }
        ]
      },
      {
        name: "Olive Oil",
        ...
        subItems: [
          { name: "Olive Oil", description: "Gourmet use. Price: Not specified", priceRange: "Submit Request For Rates" }
        ]
      },
      {
        name: "Specialty Oils",
